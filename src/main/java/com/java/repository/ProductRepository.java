...
public interface ProductRepository extends JpaRepository<Products, Long>{
	...
	@Query("select new com.java.dto.ProductsDto(products.id, products.category_id, products.name, products.price, products.added_on, products.exprideDate, products.inStock, products.unitSold, products.urlImg, products.description, c.name, products.totalReview, products.totalReview5Star, products.fileId) from Products products, Category c Where CONCAT(products.name, ' ', products.description, ' ', c.name) LIKE %:key% and products.category=c  ORDER BY products.id DESC")
	List<ProductsDto> searchAdmin(@Param("key") String key);
	@Query("select new com.java.dto.ProductsDto(products.id, products.category_id, products.name, products.price, products.added_on, products.exprideDate, products.inStock, products.unitSold, products.urlImg, products.description, c.name, products.totalReview, products.totalReview5Star, products.fileId) from Products products, Category c WHERE products.category_id = :category_id and products.category = c ORDER BY products.id DESC ")
	Page<ProductsDto> getProductsByCategoryId (@Param("category_id") long categoryId, Pageable pageable);
	
	@Query("select new com.java.dto.ProductsDto(products.id, products.category_id, products.name, products.price, products.added_on, products.exprideDate, products.inStock, products.unitSold, products.urlImg, products.description, c.name, products.totalReview, products.totalReview5Star, products.fileId) from Products products, Category c Where products.category = c ORDER BY products.id DESC")
	...
	@Query("select new com.java.dto.ProductsDto(products.id, products.category_id, products.name, products.price, products.added_on, products.exprideDate, products.inStock, products.unitSold, products.urlImg, products.description, c.name, products.totalReview, products.totalReview5Star, products.fileId) from Products products, Category c Where products.category=c")
	...
	@Query("select new com.java.dto.ProductsDto(products.id, products.category_id, products.name, products.price, products.added_on, products.exprideDate, products.inStock, products.unitSold, products.urlImg, products.description, c.name, products.totalReview, products.totalReview5Star, products.fileId) from Products products, Category c Where products.id= :id and products.category=c ")
